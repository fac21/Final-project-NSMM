...
('Neville', 'Keemer', 'n@g.com', 'bytesized', 'chummy02', '1975-11-05', 'male', (ARRAY[1,3,4]), 'https://avatars.githubusercontent.com/u/60395899?v=4', 'London', 'I like sport, music and the great outdooors and would like to meet for gig')
;
...
(1, 1, 2, 'Anyone free for coffee, tues 8th June, 6pm?', 'I will be in Finsbury Park and will have a couple if hours free. Would love to meet up for coffee. Please message if available.', (SELECT CURRENT_TIMESTAMP), 'London', 'evening'),
(2, 2, 1, 'Drinks this weekend, central London', 'Anyone wanna go for a drink this weekend in central London please message me', (SELECT CURRENT_TIMESTAMP), 'London', 'evening')
;
